...
const openapi_farcaster_1 = require("./openapi-farcaster");
const axios_1 = __importStar(require("axios"));
const logger_1 = require("../common/logger");
const openapi_recommendation_1 = require("./openapi-recommendation");
...
class NeynarV2APIClient {
    ...
    constructor(apiKey, { basePath, logger = logger_1.silentLogger, axiosInstance, } = {}) {
        ...
        const config = new openapi_farcaster_1.Configuration({
            basePath: basePath ? `${basePath}/v2` : BASE_PATH,
            apiKey: apiKey,
        });
        this.apis = {
            signer: new openapi_farcaster_1.SignerApi(config, undefined, axiosInstance),
            user: new openapi_farcaster_1.UserApi(config, undefined, axiosInstance),
            cast: new openapi_farcaster_1.CastApi(config, undefined, axiosInstance),
            reaction: new openapi_farcaster_1.ReactionApi(config, undefined, axiosInstance),
            feed: new openapi_farcaster_1.FeedApi(config, undefined, axiosInstance),
            notifications: new openapi_farcaster_1.NotificationsApi(config, undefined, axiosInstance),
            channel: new openapi_farcaster_1.ChannelApi(config, undefined, axiosInstance),
            follows: new openapi_farcaster_1.FollowsApi(config, undefined, axiosInstance),
            storage: new openapi_farcaster_1.StorageApi(config, undefined, axiosInstance),
            nft: new openapi_recommendation_1.NFTApi(config, undefined, axiosInstance),
            fname: new openapi_farcaster_1.FnameApi(config, undefined, axiosInstance),
            frame: new openapi_farcaster_1.FrameApi(config, undefined, axiosInstance),
            webhook: new openapi_farcaster_1.WebhookApi(config, undefined, axiosInstance),
            mute: new openapi_farcaster_1.MuteApi(config, undefined, axiosInstance),
        };
    }
    /**
    ...
    */
    async fetchAuthorizationUrl(client_id, code) {
        const response = await this.apis.signer.fetchAuthorizationUrl(this.apiKey, client_id, code);
     ...
     */
    async registerSignedKey(signerUuid, fid, deadline, signature) {
        ...
        const response = await this.apis.signer.registerSignedKey(this.apiKey, registerSignerKeyReqBody);
        return response.data;
    }
     ...
     */
    async lookupDeveloperManagedSigner(publicKey) {
        const response = await this.apis.signer.developerManagedSigner(this.apiKey, publicKey);
        return response.data;
    }
    /**
     ...
     */
    async registerSignedKeyForDeveloperManagedSigner(publicKey, signature, appFid, deadline) {
        const registerSignerKeyReqBody = {
        ...
        const response = await this.apis.signer.registerSignedKeyForDeveloperManagedSigner(this.apiKey, registerSignerKeyReqBody);
        return response.data;
    }
    /**
     ...
     */
    async publishMessageToFarcaster(message) {
        const response = await this.apis.signer.publishMessage(this.apiKey, message);
        return response.data;
    }
    // ------------ User ------------
    /**
     ...
     */
    async registerAccount(fid, signature, requested_user_custody_address, deadline, options) {
        const registerUserReqBody = {
            signature,
            fid,
            requested_user_custody_address,
            deadline,
            fname: options === null || options === void 0 ? void 0 : options.fname,
        };
        const response = await this.apis.user.registerUser(this.apiKey, registerUserReqBody);
        return response.data;
    }
    /**
     ...
     */
    async fetchPowerUsers(options) {
        const response = await this.apis.user.powerUsers(this.apiKey, options === null || options === void 0 ? void 0 : options.limit, options === null || options === void 0 ? void 0 : options.cursor);
        return response.data;
    }
    /**
    ...
    async fetchActiveUsers(options) {
        const response = await this.apis.user.activeUsers(this.apiKey, options === null || options === void 0 ? void 0 : options.limit, options === null || options === void 0 ? void 0 : options.cursor);
        return response.data;
    }
    /**
     ...
     */
    async deleteVerification(signerUuid, address) {
        const removeVerificationReqBody = {
            signer_uuid: signerUuid,
            address,
        };
        const response = await this.apis.user.farcasterUserVerificationDelete(this.apiKey, removeVerificationReqBody);
        return response.data;
    }
    /**
     ...
     */
    async publishVerification(signerUuid, address, blockHash, ethSignature) {
        ...
        const response = await this.apis.user.farcasterUserVerificationPost(this.apiKey, addVerificationReqBody);
        return response.data;
    }
    /**
     ...
     */
    async followUser(signerUuid, targetFids) {
        const followReqBody = {
            signer_uuid: signerUuid,
            target_fids: targetFids,
        };
        const response = await this.apis.user.followUser(this.apiKey, followReqBody);
        return response.data;
    }
    /**
     ...
     */
    async unfollowUser(signerUuid, targetFids) {
        const followReqBody = {
            signer_uuid: signerUuid,
            target_fids: targetFids,
        };
        const response = await this.apis.user.unfollowUser(this.apiKey, followReqBody);
        return response.data;
    }
    /**
     ...
     */
    async updateUser(signerUuid, options) {
        const updateUserReqBody = {
            signer_uuid: signerUuid,
            bio: options === null || options === void 0 ? void 0 : options.bio,
            pfp_url: options === null || options === void 0 ? void 0 : options.pfpUrl,
            url: options === null || options === void 0 ? void 0 : options.url,
            username: options === null || options === void 0 ? void 0 : options.username,
            display_name: options === null || options === void 0 ? void 0 : options.displayName,
        };
        const response = await this.apis.user.updateUser(this.apiKey, updateUserReqBody);
        return response.data;
    }
    /**
     ...
     */
    async fetchBulkUsers(fids, options) {
        if (fids.length > 100)
            throw new Error("Maximum number of fids allowed is 100");
        const _fids = fids.join(",");
        const response = await this.apis.user.userBulk(this.apiKey, _fids, options === null || options === void 0 ? void 0 : options.viewerFid);
        return response.data;
    }
    /**
     ...
     */
    async fetchBulkUsersByEthereumAddress(addresses, options) {
        if (addresses.length > 350)
            throw new Error("Maximum number of addresses allowed is 350");
        const _addresses = addresses.join(",");
        const _addressTypes = (options === null || options === void 0 ? void 0 : options.addressTypes) && (options === null || options === void 0 ? void 0 : options.addressTypes.join(","));
        const response = await this.apis.user.userBulkByAddress(this.apiKey, _addresses, _addressTypes);
        return response.data;
    }
    /**
     ...
     */
    async searchUser(q, viewerFid, options) {
        const response = await this.apis.user.userSearch(this.apiKey, q, viewerFid, options === null || options === void 0 ? void 0 : options.limit, options === null || options === void 0 ? void 0 : options.cursor);
        return response.data;
    }
    /**
     ...
     */
    async lookupUserByCustodyAddress(custodyAddress) {
        const response = await this.apis.user.lookupUserByCustodyAddress(this.apiKey, custodyAddress);
        return response.data;
    }
    // ------------ Cast ------------
    /**
     ...
     */
    async lookUpCastByHashOrWarpcastUrl(castHashOrUrl, type) {
        const response = await this.apis.cast.cast(this.apiKey, castHashOrUrl, type);
        return response.data;
    }
    /**
     ...
     */
    async fetchBulkCasts(castsHashes, options) {
        const _castsHashes = castsHashes.join(",");
        const response = await this.apis.cast.casts(this.apiKey, _castsHashes, options === null || options === void 0 ? void 0 : options.viewerFid, options === null || options === void 0 ? void 0 : options.sortType);
        return response.data;
    }
    /**
     ...
     */
    async lookupCastConversation(castHashOrUrl, type, options) {
        const response = await this.apis.cast.castConversation(this.apiKey, castHashOrUrl, type, options === null || options === void 0 ? void 0 : options.replyDepth, options === null || options === void 0 ? void 0 : options.includeChronologicalParentCasts);
        return response.data;
    }
    /**
    ...
    async publishCast(signerUuid, text, options) {
        const postCastReqBody = {
            ...
            parent: options === null || options === void 0 ? void 0 : options.replyTo,
            channel_id: options === null || options === void 0 ? void 0 : options.channelId,
        };
        const response = await this.apis.cast.postCast(this.apiKey, postCastReqBody);
     ...
     */
    async deleteCast(signerUuid, castOrCastHash) {
        let castHash;
        ...
        const deleteCastReqBody = {
            signer_uuid: signerUuid,
            target_hash: castHash,
        };
        const response = await this.apis.cast.deleteCast(this.apiKey, deleteCastReqBody);
        return response.data;
    }
    // ------------ Feed ------------
    /**
     ...
     */
    async fetchFeed(feedType, options) {
        var _a;
        const _fids = (_a = options === null || options === void 0 ? void 0 : options.fids) === null || _a === void 0 ? void 0 : _a.join(",");
        const response = await this.apis.feed.feed(this.apiKey, feedType, options === null || options === void 0 ? void 0 : options.filterType, options === null || options === void 0 ? void 0 : options.fid, _fids, options === null || options === void 0 ? void 0 : options.parentUrl, options === null || options === void 0 ? void 0 : options.channelId, options === null || options === void 0 ? void 0 : options.embedUrl, options === null || options === void 0 ? void 0 : options.withRecasts, options === null || options === void 0 ? void 0 : options.limit, options === null || options === void 0 ? void 0 : options.cursor);
        return response.data;
    }
    /**
     ...
     */
    async fetchFeedByChannelIds(channelIds, options) {
        const _channelIds = channelIds.join(",");
        const response = await this.apis.feed.feedChannels(this.apiKey, _channelIds, options === null || options === void 0 ? void 0 : options.withRecasts, options === null || options === void 0 ? void 0 : options.viewerFid, options === null || options === void 0 ? void 0 : options.withReplies, options === null || options === void 0 ? void 0 : options.limit, options === null || options === void 0 ? void 0 : options.cursor);
        return response.data;
    }
    /**
     ...
     */
    async fetchUserFollowingFeed(fid, options) {
        const response = await this.apis.feed.feedFollowing(this.apiKey, fid, options === null || options === void 0 ? void 0 : options.viewerFid, options === null || options === void 0 ? void 0 : options.withRecasts, options === null || options === void 0 ? void 0 : options.limit, options === null || options === void 0 ? void 0 : options.cursor);
        return response.data;
    }
    /**
     ...
     */
    async fetchPopularCastsByUser(fid, options) {
        const response = await this.apis.feed.feedUserPopular(this.apiKey, fid, options === null || options === void 0 ? void 0 : options.viewerFid);
        return response.data;
    }
    /**
     ...
     */
    async fetchRepliesAndRecastsForUser(fid, options) {
        const response = await this.apis.feed.feedUserRepliesRecasts(this.apiKey, fid, options === null || options === void 0 ? void 0 : options.limit, options === null || options === void 0 ? void 0 : options.cursor, options === null || options === void 0 ? void 0 : options.viewerFid);
        return response.data;
    }
    /**
     ...
     */
    async fetchFramesOnlyFeed(options) {
        const response = await this.apis.feed.feedFrames(this.apiKey, options === null || options === void 0 ? void 0 : options.limit, options === null || options === void 0 ? void 0 : options.viewerFid, options === null || options === void 0 ? void 0 : options.cursor);
        return response.data;
    }
    /**
     ...
     */
    async fetchTrendingFeed(options) {
        const response = await this.apis.feed.feedTrending(this.apiKey, options === null || options === void 0 ? void 0 : options.limit, options === null || options === void 0 ? void 0 : options.cursor, options === null || options === void 0 ? void 0 : options.viewerFid, options === null || options === void 0 ? void 0 : options.timeWindow, options === null || options === void 0 ? void 0 : options.channelId);
        return response.data;
    }
    // ------------ Reaction ------------
    /**
     ...
     */
    async publishReactionToCast(signerUuid, reaction, castOrCastHash) {
        let castHash;
        if (typeof castOrCastHash === "string") {
            castHash = castOrCastHash;
        }
     ...
     */
    async deleteReactionFromCast(signerUuid, reaction, castOrCastHash) {
        let castHash;
        if (typeof castOrCastHash === "string") {
            castHash = castOrCastHash;
        }
     ...
     */
    async fetchUserReactions(fid, type, options) {
        const response = await this.apis.reaction.reactionsUser(this.apiKey, fid, type, options === null || options === void 0 ? void 0 : options.limit, options === null || options === void 0 ? void 0 : options.cursor);
        return response.data;
    }
    /**
     ...
     */
    async fetchCastReactions(hash, types, options) {
        const response = await this.apis.reaction.reactionsCast(this.apiKey, hash, types, options === null || options === void 0 ? void 0 : options.limit, options === null || options === void 0 ? void 0 : options.cursor);
        return response.data;
    }
    // ------------ Notifications ------------
    /**
     ...
     */
    async fetchAllNotifications(fid, options) {
        const response = await this.apis.notifications.notifications(this.apiKey, fid, options === null || options === void 0 ? void 0 : options.cursor);
        return response.data;
    }
    /**
     ...
     */
    async fetchChannelNotificationsForUser(fid, channelIds, options) {
        const _channelIds = channelIds.join(",");
        const response = await this.apis.notifications.notificationsChannel(this.apiKey, fid, _channelIds, options === null || options === void 0 ? void 0 : options.cursor);
        return response.data;
    }
    /**
     ...
     */
    async fetchNotificationsByParentUrlForUser(fid, parentUrls, options) {
        const _parentUrls = parentUrls.join(",");
        const response = await this.apis.notifications.notificationsParentUrl(this.apiKey, fid, _parentUrls, options === null || options === void 0 ? void 0 : options.cursor);
        return response.data;
    }
    // ------------ Channel ------------
    /**
   ...
   */
    async fetchUserChannels(fid, options) {
        const response = await this.apis.channel.userChannels(this.apiKey, fid, options === null || options === void 0 ? void 0 : options.limit, options === null || options === void 0 ? void 0 : options.cursor);
        return response.data;
    }
    /**
     ...
     */
    async lookupChannel(id, options) {
        const response = await this.apis.channel.channelDetails(this.apiKey, id, options === null || options === void 0 ? void 0 : options.viewerFid);
        return response.data;
    }
    /**
     ...
     */
    async fetchUsersActiveChannels(fid, options) {
        const response = await this.apis.channel.activeChannels(this.apiKey, fid, options === null || options === void 0 ? void 0 : options.limit, options === null || options === void 0 ? void 0 : options.cursor);
        return response.data;
    }
    /**
     ...
     */
    async fetchActiveUsersInSingleChannel(id, hasRootCastAuthors, options) {
        const response = await this.apis.channel.channelUsers(this.apiKey, id, hasRootCastAuthors, options === null || options === void 0 ? void 0 : options.hasCastLikers, options === null || options === void 0 ? void 0 : options.hasCastRecasters, options === null || options === void 0 ? void 0 : options.hasReplyAuthors, options === null || options === void 0 ? void 0 : options.cursor, options === null || options === void 0 ? void 0 : options.limit);
        return response.data;
    }
    /**
     ...
     */
    async fetchAllChannels(options) {
        const response = await this.apis.channel.listAllChannels(this.apiKey, options === null || options === void 0 ? void 0 : options.limit, options === null || options === void 0 ? void 0 : options.cursor);
        return response.data;
    }
    /**
     ...
     */
    async fetchTrendingChannels(timeWindow, options) {
        const response = await this.apis.channel.trendingChannels(this.apiKey, timeWindow, options === null || options === void 0 ? void 0 : options.limit, options === null || options === void 0 ? void 0 : options.cursor);
        return response.data;
    }
    /**
     ...
     */
    async fetchFollowersForAChannel(id, options) {
        const response = await this.apis.channel.channelFollowers(this.apiKey, id, options === null || options === void 0 ? void 0 : options.cursor, options === null || options === void 0 ? void 0 : options.limit);
        return response.data;
    }
    // ------------ Follows ------------
    /**
     ...
     */
    async fetchRelevantFollowers(targetFid, viewerFid) {
        const response = await this.apis.follows.relevantFollowers(this.apiKey, targetFid, viewerFid);
        return response.data;
    }
    // ------------ Storage ------------
    /**
     ...
     */
    async lookupUserStorageAllocations(fid) {
        const response = await this.apis.storage.storageAllocations(this.apiKey, fid);
        return response.data;
    }
    /**
     ...
     */
    async lookupUserStorageUsage(fid) {
     ...
     */
    async isFnameAvailable(fname) {
        const response = await this.apis.fname.fnameAvailability(this.apiKey, fname);
        return response.data;
    }
    // ------------ Frame ------------
    /**
    ...
    async publishNeynarFrame(neynarFrameCreationRequest) {
        const response = await this.apis.frame.publishNeynarFrame(this.apiKey, neynarFrameCreationRequest);
        return response.data;
    }
    /**
    ...
    async updateNeynarFrame(neynarFrameUpdateRequest) {
        const response = await this.apis.frame.updateNeynarFrame(this.apiKey, neynarFrameUpdateRequest);
        return response.data;
    }
    /**
     ...
     */
    async deleteNeynarFrame(uuid) {
        const deleteNeynarFrameRequest = {
            uuid,
        };
        const response = await this.apis.frame.deleteNeynarFrame(this.apiKey, deleteNeynarFrameRequest);
        return response.data;
    }
    /**
     ...
     */
    async postFrameAction(signerUuid, castHash, action) {
        const body = {
            signer_uuid: signerUuid,
            cast_hash: castHash,
            action,
     ...
     */
    async validateFrameAction(messageBytesInHex, options) {
        const reqBody = Object.assign(Object.assign(Object.assign(Object.assign({ message_bytes_in_hex: messageBytesInHex }, (typeof (options === null || options === void 0 ? void 0 : options.castReactionContext) !== "undefined" && {
            cast_reaction_context: options === null || options === void 0 ? void 0 : options.castReactionContext,
        })), (typeof (options === null || options === void 0 ? void 0 : options.followContext) !== "undefined" && {
            follow_context: options === null || options === void 0 ? void 0 : options.followContext,
        })), (typeof (options === null || options === void 0 ? void 0 : options.signerContext) !== "undefined" && {
            signer_context: options === null || options === void 0 ? void 0 : options.signerContext,
        })), (typeof (options === null || options === void 0 ? void 0 : options.channelFollowContext) !== "undefined" && {
            channel_follow_context: options === null || options === void 0 ? void 0 : options.channelFollowContext,
        }));
     ...
     */
    async fetchValidateFrameAnalytics(frameUrl, analyticsType, start, stop, options) {
        const response = await this.apis.frame.validateFrameAnalytics(this.apiKey, frameUrl, analyticsType, start, stop, options === null || options === void 0 ? void 0 : options.aggregateWindow);
        return response.data;
    }
    // ------------ Webhook ------------
    /**
     ...
     */
    async lookupWebhook(webhookId) {
        const response = await this.apis.webhook.lookupWebhook(this.apiKey, webhookId);
        return response.data;
    }
    /**
     ...
     */
    async publishWebhook(name, url, options) {
        const webhookPostReqBody = Object.assign({ name,
            url }, (typeof (options === null || options === void 0 ? void 0 : options.subscription) !== "undefined" && {
            subscription: options === null || options === void 0 ? void 0 : options.subscription,
        }));
        const response = await this.apis.webhook.publishWebhook(this.apiKey, webhookPostReqBody);
        return response.data;
    }
    /**
     ...
     */
    async updateWebhookActiveStatus(webhookId, active) {
        const webhookPatchReqBody = {
            webhook_id: webhookId,
            active: active.toString(),
        };
        const response = await this.apis.webhook.updateWebhookActiveStatus(this.apiKey, webhookPatchReqBody);
        return response.data;
    }
    /**
     ...
     */
    async updateWebhook(webhookId, name, url, options) {
        const webhookPutReqBody = Object.assign({ name,
            url, webhook_id: webhookId }, (typeof (options === null || options === void 0 ? void 0 : options.subscription) !== "undefined" && {
            subscription: options === null || options === void 0 ? void 0 : options.subscription,
        }));
        const response = await this.apis.webhook.updateWebhook(this.apiKey, webhookPutReqBody);
        return response.data;
    }
    /**
     ...
     */
    async fetchRelevantMints(address, contractAddress, options) {
        const response = await this.apis.nft.fetchRelevantMints(this.apiKey, address, contractAddress, options === null || options === void 0 ? void 0 : options.tokenId);
        return response.data;
    }
    // ------------ Mute ------------
    /**
       ...
       */
    async fetchMuteList(fid, options) {
        const response = await this.apis.mute.muteList(this.apiKey, fid, options === null || options === void 0 ? void 0 : options.limit, options === null || options === void 0 ? void 0 : options.cursor);
        return response.data;
    }
    /**
           ...
           *
       */
    async publishMute(fid, mutedFid) {
        const addMuteBody = {
            fid,
            muted_fid: mutedFid,
        };
    ...
    */
    async deleteMute(fid, mutedFid) {
        const deleteMuteBody = {
            fid,
            muted_fid: mutedFid,
        };
        const response = await this.apis.mute.deleteMute(this.apiKey, deleteMuteBody);
        return response.data;
    }
}
